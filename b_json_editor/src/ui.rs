...
pub fn ui(f: &mut Frame, app: &App) {
    ...
    let current_navigation_text = vec![
        ...
        // Final section, with keybindings
        match app.currently_editing {
            ...
            _ => Span::styled("Not Editing", Style::default().fg(Color::DarkGray)),
        },
    ];
...
fn centered_rect(percent_x: u16, percent_y: u16, r: Rect) -> Rect {
    // Cut given rectangle into three vertical pieces
    ...
    // Then cut the middle part into three pieces
    Layout::default()
        .direction(Direction::Horizontal)
        .constraints([
